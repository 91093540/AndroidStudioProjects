package com.example.simplecalculatorv3;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        multiply = findViewById(R.id.ib_multiply);
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.ib_num0) {
            ...
            multiply.setBackgroundColor(Color.LTGRAY);
        ...
        else if(v.getId() == R.id.ib_multiply) {
            multiply.setBackgroundColor(Color.rgb(3,37,91));
            plus.setBackgroundColor(Color.LTGRAY);
            minus.setBackgroundColor(Color.LTGRAY);
            divide.setBackgroundColor(Color.LTGRAY);
            select = 3;
            ...
            divide.setBackgroundColor(Color.rgb(3,37,91));
            plus.setBackgroundColor(Color.LTGRAY);
            minus.setBackgroundColor(Color.LTGRAY);
            multiply.setBackgroundColor(Color.LTGRAY);
            select = 4;
